	...
	<
		...
		<table style="position: relative; left: 600px; bottom: 300px; border-spacing: 15px;">
			...
			<tr>
				...
				<td><input class="inputstyle" form="my_form" type="text" name="form_laufzeit"required></input></td>
			</tr>
			<tr>
			...
			<tr>
				...
				<td><select class="select_antrag"
					style="position: relative; left: 50px" form="my_form" name="form_verhaeltnis">
			...
			<tr>
				...
				<td><select class="select_antrag"
					style="position: relative; left: 50px" form="my_form" name="form_bruttoeinkommen">
						<option class="select_option" selected>Bitte wählen:</option>
						<option class="select_option" value="<1500">unter 1500 €</option>
						<option class="select_option" value="1501-2500">1501-2500 €</option>
						<option class="select_option" value="2501-3500">2501-3500 €</option>
