...
public class UserRegisterServlet extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		// Falls keine Datenbankverbindung hergestellt werden kann, wird auf die registration.jsp zur�ckgeleitet und eine Fehlermeldung ausgegeben
		MySQL.initTables();
		...
		// �berpr�fung welcher Wert zur�ckgegeben wurde und dementsprechende Weiterleitung bzw. Ausgabe von Fehlermeldungen
		if (s.equals("success")) {
